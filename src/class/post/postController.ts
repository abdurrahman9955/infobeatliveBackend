...
export const createPost = async (req: Request, res: Response) => {
  try {
    ...
    const post = await prisma.classMediaUpload.create({
      data: {
        classId,
        userId,
        title,
...
export const getPostsByClassId = async (req: Request, res: Response) => {
  try {
    ...
    const posts = await prisma.classMediaUpload.findMany({
      where: { classId: classId, ...wherePosts },
      include: {
        user: {
          include: {
            profile: true,
...
export const getPostsByUserId = async (req: Request, res: Response) => {
  try {
    ...
    const resolution = req.query.resolution as string; // Optional query param
    const posts = await prisma.classMediaUpload.findMany({
      where: { classId:classId, userId: userId, ...wherePosts},
      include: {
        user: {
          include: {
            profile: true,
...
export const getPostById = async (req: Request, res: Response) => {
  try {
    ...
    const post = await prisma.classMediaUpload.findUnique({
      where: { classId:classId, id:postId },
      include: {
        user: {
          include: {
            profile: true,
...
export const updatePost = async (req: Request, res: Response) => {
  try {
    ...
    const post = await prisma.classMediaUpload.update({
      where: {classId, id },
...
export const deletePost = async (req: Request, res: Response) => {
  try {
    ...
    await prisma.classMediaUpload.delete({
      where: {classId, id},
    });
