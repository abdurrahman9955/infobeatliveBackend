...
const bootcampAdvanceClassCourseLikes = express.Router();


bootcampAdvanceClassCourseLikes.post('/class/course/user/post/like/create/:userId/:postId', async (req: Request, res: Response) => {
  try {
...
bootcampAdvanceClassCourseLikes.get('/class/course/user/Post/like/get/:postId', async (req: Request, res: Response) => {
  try {
    const postId = req.params.postId;
...
export default bootcampAdvanceClassCourseLikes;
