...
const likeBootcampAdvanceClassCourseSubComments = express.Router();


likeBootcampAdvanceClassCourseSubComments.post('/class/course/user/subComment/like/create/:userId/:subCommentId', async (req: Request, res: Response) => {
  try {
...
likeBootcampAdvanceClassCourseSubComments.get('/class/course/user/subComment/like/get/:subCommentId', async (req: Request, res: Response) => {
  try {
    const subCommentId = req.params.subCommentId;
...
export default likeBootcampAdvanceClassCourseSubComments;
