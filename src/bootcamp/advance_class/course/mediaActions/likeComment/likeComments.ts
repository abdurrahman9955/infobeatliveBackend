...
const likeBootcampAdvanceClassCourseComments = express.Router();


likeBootcampAdvanceClassCourseComments.post('/class/course/user/comment/like/create/:userId/:commentId', async (req: Request, res: Response) => {
  try {
...
likeBootcampAdvanceClassCourseComments.get('/class/course/user/comment/like/get/:commentId', async (req: Request, res: Response) => {
  try {
    const commentId = req.params.commentId;
...
export default likeBootcampAdvanceClassCourseComments;
