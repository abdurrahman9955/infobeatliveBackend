...
const likeBootcampAdvanceClassSubComments = express.Router();


likeBootcampAdvanceClassSubComments.post('/class/user/subComment/like/create/:userId/:subCommentId', async (req: Request, res: Response) => {
  try {
...
likeBootcampAdvanceClassSubComments.get('/class/user/subComment/like/get/:subCommentId', async (req: Request, res: Response) => {
  try {
    const subCommentId = req.params.subCommentId;
...
export default likeBootcampAdvanceClassSubComments;
