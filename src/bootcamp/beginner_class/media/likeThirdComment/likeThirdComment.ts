...
const likeBootcampClassThirdComments = express.Router();


likeBootcampClassThirdComments.post('/class/user/thirdComment/like/create/:userId/:thirdCommentId', async (req: Request, res: Response) => {
  try {
...
likeBootcampClassThirdComments.get('/class/user/thirdComment/like/get/:thirdCommentId', async (req: Request, res: Response) => {
  try {
    const thirdCommentId = req.params.thirdCommentId;
...
export default likeBootcampClassThirdComments;
