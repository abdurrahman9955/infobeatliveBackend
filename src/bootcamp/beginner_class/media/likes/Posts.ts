...
const bootcampClassLikes = express.Router();

bootcampClassLikes.post('/class/user/post/like/create/:userId/:postId', async (req: Request, res: Response) => {
  try {
...
bootcampClassLikes.get('/class/user/Post/like/get/:postId', async (req: Request, res: Response) => {
  try {
    const postId = req.params.postId;
...
export default bootcampClassLikes;
