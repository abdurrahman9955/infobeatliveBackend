...
const likeBootcampClassCourseSubComments = express.Router();


likeBootcampClassCourseSubComments.post('/class/course/user/subComment/like/create/:userId/:subCommentId', async (req: Request, res: Response) => {
  try {
...
likeBootcampClassCourseSubComments.get('/class/course/user/subComment/like/get/:subCommentId', async (req: Request, res: Response) => {
  try {
    const subCommentId = req.params.subCommentId;
...
export default likeBootcampClassCourseSubComments;
