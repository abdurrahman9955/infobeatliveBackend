...
const likeBootcampIntermediateClassThirdComments = express.Router();


likeBootcampIntermediateClassThirdComments.post('/class/user/thirdComment/like/create/:userId/:thirdCommentId', async (req: Request, res: Response) => {
  try {
...
likeBootcampIntermediateClassThirdComments.get('/class/user/thirdComment/like/get/:thirdCommentId', async (req: Request, res: Response) => {
  try {
    const thirdCommentId = req.params.thirdCommentId;
...
export default likeBootcampIntermediateClassThirdComments;
