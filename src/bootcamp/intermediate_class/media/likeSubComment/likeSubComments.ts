...
const likeBootcampIntermediateClassSubComments = express.Router();


likeBootcampIntermediateClassSubComments.post('/class/user/subComment/like/create/:userId/:subCommentId', async (req: Request, res: Response) => {
  try {
...
likeBootcampIntermediateClassSubComments.get('/class/user/subComment/like/get/:subCommentId', async (req: Request, res: Response) => {
  try {
    const subCommentId = req.params.subCommentId;
...
export default likeBootcampIntermediateClassSubComments;
