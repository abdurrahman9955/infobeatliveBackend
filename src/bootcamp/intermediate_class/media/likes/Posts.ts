...
const bootcampIntermediateClassLikes = express.Router();

bootcampIntermediateClassLikes.post('/class/user/post/like/create/:userId/:postId', async (req: Request, res: Response) => {
  try {
...
bootcampIntermediateClassLikes.get('/class/user/Post/like/get/:postId', async (req: Request, res: Response) => {
  try {
    const postId = req.params.postId;
...
export default bootcampIntermediateClassLikes;
