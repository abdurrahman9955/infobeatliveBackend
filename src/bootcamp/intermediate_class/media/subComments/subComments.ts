...
bootcampIntermediateClassSubComments.post('/class/user/create/subComment/:userId/:commentId', async (req:Request, res: Response) => {
  try {
...
bootcampIntermediateClassSubComments.delete('/class/user/delete/subComment/:commentId', async (req:Request, res: Response) => {
  try {
    const commentId = req.params.commentId;
...
export default bootcampIntermediateClassSubComments;
