...
const bootcampIntermediateClassCourseLikes = express.Router();


bootcampIntermediateClassCourseLikes.post('/class/course/user/post/like/create/:userId/:postId', async (req: Request, res: Response) => {
  try {
...
bootcampIntermediateClassCourseLikes.get('/class/course/user/Post/like/get/:postId', async (req: Request, res: Response) => {
  try {
    const postId = req.params.postId;
...
export default bootcampIntermediateClassCourseLikes;
