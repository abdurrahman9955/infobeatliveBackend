...
const likeSubComments = express.Router();


likeSubComments.post('/user/subComment/like/create/:userId/:subCommentId', async (req: Request, res: Response) => {
  try {
...
likeSubComments.get('/user/subComment/like/get/:subCommentId', async (req: Request, res: Response) => {
  try {
    const subCommentId = req.params.subCommentId;
...
export default likeSubComments;
