...
routerOtpLogin.post('/verifySignInOtp', async (req: Request, res: Response) => {
  try {
...
routerOtpLogin.post('/resend/SignInOtp', async (req, res) => {
  try {
    ...
    Message: {
      Body: {
        Text: {
          ...
          Please use this OTP to complete your login on advertConnectPro.
      ...
      Subject: {
        Data: 'Your OTP for sign-in to advertConnectPro',
      },
    },
